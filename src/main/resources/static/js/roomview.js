    ...
    var markers = $(data.positions).map(function(i, position) {
        ...
        kakao.maps.event.addListener(marker, 'click', function() {
            ...
            var customOverlay = new kakao.maps.CustomOverlay({
                map: map2,
                // content: "<div style='padding:0 5px;background:black;'>" + position.roomNo + "," + position.roomImg + "<br><a href='/room/view/" + position.roomNo + "'>바로가기</a></div>", // 내용물
                content: document.getElementById('mappopup'),
