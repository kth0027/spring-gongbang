    ...
    public String channelregistration(@RequestParam("memberNo") int memberNo,
        ...
        try {
            ...
            if (!file.getOriginalFilename().equals("")) { // 02-17 조지훈
                ...
                // String dir =
                // "C:\\Users\\pc\\git\\spring-gongbang\\build\\resources\\main\\static\\channelimg";

                // vs 코드
                String dir = "C:\\Users\\pc\\git\\spring-gongbang\\src\\main\\resources\\static\\channelimg";

                // String dir =
                // "/home/ec2-user/gongbang-jj/build/resources/main/static/channelimg";
